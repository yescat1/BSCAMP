...
# worker-startup log.
CUSTOM_COMMANDS = [['apt-get', 'update'], ['apt-get', '--assume-yes', 'install', 'cmake'], ['pip', 'install', 'pyscamp'], ['pip', 'install', 'google-cloud-storage'], ['echo', 'Custom command worked!']]
...
setuptools.setup(
    name='scikit-build',
    version='0.11.1',
    description='Scikit-build package.',
